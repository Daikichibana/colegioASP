<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmApoderado.aspx.cs" Inherits="PRESENTACION.frmApoderado" %>
...
<body>
    <center>
        ...
        <form id="form1" runat="server">
            <div>
                <asp:Table runat="server">
                    <asp:TableRow>
                        ...
                        <asp:TableCell><asp:TextBox ID="txtIdApoderado" Type="hidden" runat="server"></asp:TextBox></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
            ...
            <br />
            <div>
                <label>Listado de Apoderados</label><br />
